public static void LeftArmGun()//UND
{
    if (ControllerInputPoller.instance.leftGrab)
    {
        Physics.Raycast(GorillaLocomotion.Player.Instance.leftControllerTransform.position, -GorillaLocomotion.Player.Instance.leftControllerTransform.up, out var hitInfo);
        if (change17 == 1)
        {
        ...
        if (change17 == 2 | change17 == 3)
        {
            ...
            Line.SetPosition(0, GorillaLocomotion.Player.Instance.leftControllerTransform.position);
        ...
        {
            GorillaLocomotion.Player.Instance.leftControllerTransform.position = hitInfo.point;
        }
    }
    if (pointer != null)
    {
